...
class SystemHealthController:
 def __init__(self,service,authorization=None,*,security_disabled=False):self.service=service;self.authorization=authorization;self.security_disabled=security_disabled
 def require(self):
