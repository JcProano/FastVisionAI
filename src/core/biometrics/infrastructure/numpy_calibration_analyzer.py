...
class NumpyCalibrationAnalyzer:
    ...
    def calibrate(
        ...
        *,
        ...
        valid = sum(
            _enum_value(sample.metadata.alignment_quality) == "valid"
...
def _low(left, right):
    return (_enum_value(left.metadata.alignment_quality) == "low_quality" or
            _enum_value(right.metadata.alignment_quality) == "low_quality")
