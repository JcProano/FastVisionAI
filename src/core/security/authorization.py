...
_OPERATOR = {P.VIEW_DASHBOARD,P.VIEW_PEOPLE,P.EDIT_PERSON,P.CHANGE_PERSON_STATUS,P.ENROLL_PERSON,P.VIEW_REPORTS,P.VIEW_ATTENDANCE,P.MANUAL_ATTENDANCE,P.VIEW_DETECTION_HISTORY,P.APPLICATION_EXIT}
_AUDITOR = {P.VIEW_DASHBOARD,P.VIEW_PEOPLE,P.VIEW_REPORTS,P.EXPORT_REPORTS,P.VIEW_ATTENDANCE,P.VIEW_DETECTION_HISTORY,P.VIEW_AUDIT,P.EXPORT_AUDIT,P.APPLICATION_EXIT}
_VIEWER = {P.VIEW_DASHBOARD,P.VIEW_PEOPLE,P.VIEW_REPORTS,P.VIEW_ATTENDANCE,P.VIEW_DETECTION_HISTORY,P.APPLICATION_EXIT}
